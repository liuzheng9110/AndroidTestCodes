...
public class NotificationConst {
	...
	public final static int BTN_ID_LIKE = 0;  // 喜欢
	public final static int BTN_ID_PREV = 1;  // 上一首
	public final static int BTN_ID_PLAY = 2;  // 暂停/播放
	public final static int BTN_ID_NEXT = 3;  // 下一首
	public final static int BTN_ID_CANCLE = 4;// 取消
