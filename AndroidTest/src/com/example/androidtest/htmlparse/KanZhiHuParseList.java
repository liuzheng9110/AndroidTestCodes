...
public class KanZhiHuParseList {
	
	private static ArrayList<HtmlParseListBean> htmlParseBeans = new ArrayList<HtmlParseListBean>();
	
	public static ArrayList<HtmlParseListBean> getHtmlParseBeans() {
		return htmlParseBeans;
	}
	
	public static ArrayList<HtmlParseListBean> getListHtml() {
		try {
...
//			System.out.println(element.outerHtml());// 某一个 article 的html 内容
	...
	private static void articleHtmlParse(Element allElement) {
		HtmlParseListBean htmlParseBean = new HtmlParseListBean();
